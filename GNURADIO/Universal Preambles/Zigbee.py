...
class Zigbee(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.filepath2 = filepath2 = '/home/spencer/Documents/SeniorDesign/Git/dynamic-preambles/GNURADIO/Universal Preambles/Preambles/SigSet696_MonteCarlo1k_3.csv'
        self.filepath = filepath = '/home/spencer/Documents/SeniorDesign/Git/dynamic-preambles/GNURADIO/Universal Preambles/Preambles/SigSet696_MonteCarlo1k_3.csv'
        ...
        self._filepath2_options = ['/home/spencer/Documents/SeniorDesign/Git/dynamic-preambles/GNURADIO/Universal Preambles/Preambles/SigSet696_MonteCarlo1k_3.csv', '/home/spencer/Documents/SeniorDesign/Git/dynamic-preambles/GNURADIO/Universal Preambles/Preambles/SigSet696_MonteCarlo1k_4.csv']
        # Create the labels list
        self._filepath2_labels = ['Preamble 4', 'Preamble 5']
        ...
        # Create the options list
        self._filepath_options = ['/home/spencer/Documents/SeniorDesign/Git/dynamic-preambles/GNURADIO/Universal Preambles/Preambles/SigSet696_MonteCarlo1k_3.csv', '/home/spencer/Documents/SeniorDesign/Git/dynamic-preambles/GNURADIO/Universal Preambles/Preambles/SigSet696_MonteCarlo1k_4.csv']
        # Create the labels list
        ...
        self.uhd_usrp_source_0_0.set_normalized_gain(rx_gain, 1)
        ...
        self.uhd_usrp_sink_0_0.set_samp_rate(5e6)
        ...
        self.uhd_usrp_sink_0_0.set_normalized_gain(tx_gain, 1)
        self.uhd_usrp_sink_0_0.set_min_output_buffer(65536)
        ...
        self.uhd_usrp_sink_0.set_normalized_gain(tx_gain, 1)
        ...
        self.rational_resampler_xxx_1_0 = filter.rational_resampler_ccc(
                ...
                taps=[],
                fractional_bw=0)
        self.rational_resampler_xxx_1_0.set_min_output_buffer(65536)
        ...
        self.rational_resampler_xxx_0 = filter.rational_resampler_ccf(
                ...
                taps=[],
                fractional_bw=0)
        self.qtgui_time_sink_x_1_0_0_0_1 = qtgui.time_sink_f(
            1024, #size
            5000000, #samp_rate
            "Correlation (Rx)", #name
            1, #number of inputs
        ...
        self.qtgui_time_sink_x_1_0_0_0_1.set_update_time(0.10)
        self.qtgui_time_sink_x_1_0_0_0_1.set_y_axis(-.1, 1.1)

        self.qtgui_time_sink_x_1_0_0_0_1.set_y_label('', "")

        self.qtgui_time_sink_x_1_0_0_0_1.enable_tags(True)
        self.qtgui_time_sink_x_1_0_0_0_1.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, .8, .000040, 0, "")
        self.qtgui_time_sink_x_1_0_0_0_1.enable_autoscale(False)
        self.qtgui_time_sink_x_1_0_0_0_1.enable_grid(False)
        self.qtgui_time_sink_x_1_0_0_0_1.enable_axis_labels(True)
        self.qtgui_time_sink_x_1_0_0_0_1.enable_control_panel(False)
        self.qtgui_time_sink_x_1_0_0_0_1.enable_stem_plot(False)

        self.qtgui_time_sink_x_1_0_0_0_1.disable_legend()
        ...
        for i in range(1):
            if len(labels[i]) == 0:
                self.qtgui_time_sink_x_1_0_0_0_1.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_time_sink_x_1_0_0_0_1.set_line_label(i, labels[i])
            self.qtgui_time_sink_x_1_0_0_0_1.set_line_width(i, widths[i])
            self.qtgui_time_sink_x_1_0_0_0_1.set_line_color(i, colors[i])
            self.qtgui_time_sink_x_1_0_0_0_1.set_line_style(i, styles[i])
            self.qtgui_time_sink_x_1_0_0_0_1.set_line_marker(i, markers[i])
            self.qtgui_time_sink_x_1_0_0_0_1.set_line_alpha(i, alphas[i])

        self._qtgui_time_sink_x_1_0_0_0_1_win = sip.wrapinstance(self.qtgui_time_sink_x_1_0_0_0_1.qwidget(), Qt.QWidget)
        self.Messaging_grid_layout_1.addWidget(self._qtgui_time_sink_x_1_0_0_0_1_win, 2, 0, 1, 1)
        for r in range(2, 3):
            self.Messaging_grid_layout_1.setRowStretch(r, 1)
        for c in range(0, 1):
            self.Messaging_grid_layout_1.setColumnStretch(c, 1)
        ...
        self.Messaging_grid_layout_1.addWidget(self._qtgui_time_sink_x_0_0_1_0_win, 3, 0, 1, 1)
        for r in range(3, 4):
            self.Messaging_grid_layout_1.setRowStretch(r, 1)
        for c in range(0, 1):
            self.Messaging_grid_layout_1.setColumnStretch(c, 1)
        ...
        self.Messaging_grid_layout_1.addWidget(self._qtgui_edit_box_msg_0_0_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.Messaging_grid_layout_1.setRowStretch(r, 1)
        for c in range(0, 1):
            self.Messaging_grid_layout_1.setColumnStretch(c, 1)
        ...
        for c in range(0, 1):
            self.Messaging_grid_layout_0.setColumnStretch(c, 1)
        self.network_socket_pdu_1_0 = network.socket_pdu('UDP_CLIENT', '127.0.0.1', '52002', 10000, False)
        ...
        self.blocks_tagged_stream_multiply_length_0_0 = blocks.tagged_stream_multiply_length(gr.sizeof_gr_complex*1, "packet_len", 5/4)
        self.blocks_tagged_stream_multiply_length_0_0.set_min_output_buffer(65536)
        ...
        self.UConn2402_fftXCorr_0_0 = UConn2402.fftXCorr(filepath2)
        ...
        self.UConn2402_Preamble_0_0 = UConn2402.Preamble(filepath2, "packet_len")
        self.UConn2402_Preamble_0_0.set_min_output_buffer(65536)
        self.UConn2402_Preamble_0 = UConn2402.Preamble(filepath, "packet_len")
        self.UConn2402_Preamble_0.set_min_output_buffer(65536)
        ...
        self.msg_connect((self.ieee802_15_4_rime_stack_0_0, 'bcout'), (self.UConn2402_ArbitrarySync2_0_0, 'stop'))
        self.msg_connect((self.ieee802_15_4_rime_stack_0_0, 'toMAC'), (self.ieee802_15_4_mac_0_0, 'app in'))
        self.msg_connect((self.ieee802_15_4_rime_stack_0_0, 'bcout'), (self.network_socket_pdu_1_0, 'pdus'))
        ...
        self.connect((self.UConn2402_ArbitrarySync2_0_0, 0), (self.ieee802_15_4_oqpsk_phy_0_0, 0))
        ...
        self.connect((self.UConn2402_Preamble_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.UConn2402_Preamble_0_0, 0), (self.blocks_multiply_const_vxx_0_0, 0))
        self.connect((self.UConn2402_Preamble_0_0, 0), (self.qtgui_time_sink_x_0_0_1_0, 0))
        self.connect((self.UConn2402_Preamble_0_0, 0), (self.uhd_usrp_sink_0_0, 1))
        ...
        self.connect((self.UConn2402_fftXCorr_0_0, 0), (self.UConn2402_ArbitrarySync2_0_0, 1))
        self.connect((self.UConn2402_fftXCorr_0_0, 0), (self.qtgui_time_sink_x_1_0_0_0_1, 0))
        ...
        self.connect((self.blocks_tagged_stream_multiply_length_0_0, 0), (self.UConn2402_Preamble_0_0, 0))
        self.connect((self.ieee802_15_4_oqpsk_phy_0, 0), (self.rational_resampler_xxx_1, 0))
        self.connect((self.ieee802_15_4_oqpsk_phy_0_0, 0), (self.rational_resampler_xxx_1_0, 0))
        self.connect((self.rational_resampler_xxx_0, 0), (self.UConn2402_ArbitrarySync2_0, 0))
        self.connect((self.rational_resampler_xxx_0_1, 0), (self.UConn2402_ArbitrarySync2_0_0, 0))
        self.connect((self.rational_resampler_xxx_1, 0), (self.blocks_tagged_stream_multiply_length_0, 0))
        self.connect((self.rational_resampler_xxx_1_0, 0), (self.blocks_tagged_stream_multiply_length_0_0, 0))
        self.connect((self.uhd_usrp_source_0_0, 0), (self.UConn2402_fftXCorr_0, 0))
        self.connect((self.uhd_usrp_source_0_0, 1), (self.UConn2402_fftXCorr_0_0, 0))
        self.connect((self.uhd_usrp_source_0_0, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.uhd_usrp_source_0_0, 1), (self.rational_resampler_xxx_0_1, 0))
    ...
    def set_tx_gain(self, tx_gain):
        ...
        self.uhd_usrp_sink_0.set_normalized_gain(self.tx_gain, 1)
        self.uhd_usrp_sink_0_0.set_normalized_gain(self.tx_gain, 0)
        self.uhd_usrp_sink_0_0.set_normalized_gain(self.tx_gain, 1)
    ...
    def set_rx_gain(self, rx_gain):
        ...
        self.uhd_usrp_source_0_0.set_normalized_gain(self.rx_gain, 1)
    ...
    def set_filepath2(self, filepath2):
        ...
        self._filepath2_callback(self.filepath2)
        self.UConn2402_Preamble_0_0.open(self.filepath2)
        self.UConn2402_fftXCorr_0_0.open(self.filepath2)
