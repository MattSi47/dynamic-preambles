...
import time
from wifiAP import wifiAP  # grc-generated hier_block
from zigbeeAP import zigbeeAP  # grc-generated hier_block
...
class AP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.zigbeeAP_0 = zigbeeAP()
        self.wifiAP_0 = wifiAP(
            freq=5890000000,
        )
        ...
        self.blocks_message_strobe_0_0 = blocks.message_strobe(pmt.intern("AP BURST| 100pckt|"), 1000)
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern("AP ZIGBEE BURST| 100pckt|"), 1000)
        self.UConn2402_StatusMessage_0_0 = UConn2402.StatusMessage(100)
        self.UConn2402_StatusMessage_0 = UConn2402.StatusMessage(100)
        ...
        self.msg_connect((self.UConn2402_GUIMessagePrefixer_0, 'msg_out'), (self.wifiAP_0, 'msg_in'))
        self.msg_connect((self.UConn2402_GUIMessagePrefixer_0_0, 'clear'), (self.qtgui_edit_box_msg_0_0, 'val'))
        self.msg_connect((self.UConn2402_GUIMessagePrefixer_0_0, 'msg_out'), (self.zigbeeAP_0, 'msg_in'))
        self.msg_connect((self.UConn2402_StatusMessage_0, 'status'), (self.zigbeeAP_0, 'msg_in'))
        self.msg_connect((self.UConn2402_StatusMessage_0_0, 'status'), (self.wifiAP_0, 'msg_in'))
        self.msg_connect((self.blocks_message_strobe_0, 'strobe'), (self.UConn2402_StatusMessage_0, 'strobe'))
        self.msg_connect((self.blocks_message_strobe_0_0, 'strobe'), (self.UConn2402_StatusMessage_0_0, 'strobe'))
        ...
        self.msg_connect((self.wifiAP_0, 'msg_out'), (self.UConn2402_ArbitrarySync2_1, 'stop'))
        self.msg_connect((self.wifiAP_0, 'msg_out'), (self.network_socket_pdu_0_0, 'pdus'))
        self.msg_connect((self.zigbeeAP_0, 'msg_out'), (self.UConn2402_ArbitrarySync2_0, 'stop'))
        self.msg_connect((self.zigbeeAP_0, 'msg_out'), (self.network_socket_pdu_0_0, 'pdus'))
        self.connect((self.UConn2402_ArbitrarySync2_0, 0), (self.zigbeeAP_0, 0))
        self.connect((self.UConn2402_ArbitrarySync2_1, 0), (self.wifiAP_0, 0))
        self.connect((self.UConn2402_Chirp_0, 0), (self.qtgui_time_sink_x_0_0_1, 0))
        self.connect((self.UConn2402_Chirp_0, 0), (self.uhd_usrp_sink_0_0, 0))
        ...
        self.connect((self.blocks_tagged_stream_multiply_length_0_0, 0), (self.uhd_usrp_sink_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_1, 0), (self.blocks_tagged_stream_multiply_length_0_0, 0))
        ...
        self.connect((self.wifiAP_0, 0), (self.UConn2402_Chirp_0, 0))
        self.connect((self.zigbeeAP_0, 0), (self.UConn2402_Chirp_0_0, 0))
