...
class wifiAP(gr.hier_block2):
    def __init__(self, freq=0):
        gr.hier_block2.__init__(
            self, "Wi-Fi Physical Layer ",
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ieee802_11_mac_0, 'app out'), (self, 'msg_out'))
        self.msg_connect((self.ieee802_11_mac_0, 'phy out'), (self.wifi_phy_hier_0, 'mac_in'))
        self.msg_connect((self, 'msg_in'), (self.ieee802_11_mac_0, 'app in'))
        ...
        self.connect((self, 0), (self.wifi_phy_hier_0, 0))
