...
class Zigbee(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_sink_0_0.set_samp_rate(4e6)
        ...
        self.Messaging_grid_layout_1.addWidget(self._qtgui_time_sink_x_1_0_0_0_0_win, 1, 0, 1, 1)
        for r in range(1, 2):
        ...
        self.Messaging_grid_layout_0.addWidget(self._qtgui_time_sink_x_1_0_0_0_win, 1, 0, 1, 1)
        for r in range(1, 2):
        ...
        for c in range(0, 1):
            self.Messaging_grid_layout_0.setColumnStretch(c, 1)
        self.network_socket_pdu_1_0 = network.socket_pdu('UDP_CLIENT', '127.0.0.1', '52001', 10000, False)
        ...
        self.UConn2402_Chirp_0.set_min_output_buffer(65536)
        ...
        self.connect((self.UConn2402_Chirp_0_0, 0), (self.uhd_usrp_sink_0_0, 1))
        self.connect((self.UConn2402_LFMChirpXCorr_0, 0), (self.UConn2402_ArbitrarySync2_0, 1))
        ...
        self.connect((self.ieee802_15_4_oqpsk_phy_0_0, 0), (self.UConn2402_Chirp_0_0, 0))
        self.connect((self.uhd_usrp_source_0_0, 0), (self.UConn2402_ArbitrarySync2_0, 0))
        self.connect((self.uhd_usrp_source_0_0, 1), (self.UConn2402_ArbitrarySync2_0_0, 0))
        self.connect((self.uhd_usrp_source_0_0, 0), (self.UConn2402_LFMChirpXCorr_0, 0))
        self.connect((self.uhd_usrp_source_0_0, 1), (self.UConn2402_LFMChirpXCorr_0_0, 0))
