...
class wifi(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_1.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, 0.8, .00004, 1, "")
        ...
        self.network_socket_pdu_0_0 = network.socket_pdu('UDP_CLIENT', '127.0.0.2', '52002', 10000, False)
        ...
        self.UConn2402_ArbitrarySync_0 = UConn2402.ArbitrarySync(0.8, 20000)
        ...
        self.connect((self.UConn2402_ArbitrarySync_0, 0), (self.wifi_phy_hier_0, 0))
        self.connect((self.UConn2402_Chirp_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.UConn2402_LFMChirpXCorr_0, 1), (self.UConn2402_ArbitrarySync_0, 1))
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.UConn2402_Chirp_0, 0))
